      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 p-6">
        ...
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <Image src="/images/blog1.png" alt="Blog"  height={453} width={870}  className="w-full" />
            <div className="p-4">
        ...
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <Image src="/images/blog2.png" alt="Blog"  height={453} width={870}  className="w-full" />
            <div className="p-4">
              <div className="flex justify-between items-center text-xs text-gray-500 mb-2">
                <span className="flex items-center gap-1">
                  <i className="fa fa-pen"></i> Surf Aviation
        ...
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <Image src="/images/blog3.png" alt="Blog" height={453} width={870} className="w-full" />
            <div className="p-4">
              <div className="flex justify-between items-center text-xs text-gray-500 mb-2">
                <span className="flex items-center gap-1">
                  <i className="fa fa-pen"></i> Surf Aviation
